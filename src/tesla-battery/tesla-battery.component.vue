    ...
    <form class="tesla-battery">
        ...
        <div class="tesla-controls cf">
            ...
            <div class="tesla-climate cf">
                ...
                <div>
                    <label class="tesla-climate__item" :class="{'tesla-heat' :!limitHeat, 'tesla-climate__item--active': tesla.climate, 'tesla-climate__item--focused': climate.focused === tesla.climate}">
                        <p class="heat">{{ (limitHeat ? 'ac' : 'heat') }} {{ tesla.climate ? 'on' : 'off' }}</p>
  ...
  methods: {
    ...
    incrementTemperature() {
      if (this.tesla.temperature < this.counterTemperature.max) {
        this.tesla.temperature =
          this.tesla.temperature + this.counterTemperature.step;
      }
    },
